    ...
    render() {
        ...
        return (
            <div style={{ textAlign: 'center', marginTop: '50px '}}>
                <div style={this.watermarkStyle}>VUHA CHANDRIKA</div>
                ...
                <select id="fontstyle" value={fontStyle} onChange=
                {this.handleStyleChange}>
                   <option value="normal">Normal</option> 
                   <option value="italic">Italic</option>
                </select>
                <label htmlFor="textDecoration">Select Text Decoration</label>
                <select id="textDecoration" value={textDecoration} 
                ...
                <div style={{ color: textColor, marginTop: '20px', 
                fontFamily: 'Arial, sans-serif', fontSize: fontSize, 
                fontStyle: fontStyle, textDecoration: textDecoration }}>
